  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-4 sm:p-6">
        ...
        <h3
          className="text-text text-[1.05rem] font-bold leading-snug mb-2 group-hover:text-accent-600 transition-colors duration-150 line-clamp-2 sm:line-clamp-3 font-playfair"
        >
          {article.title}
        </h3>

        <p className="text-text/75 text-sm leading-relaxed line-clamp-2 sm:line-clamp-3 flex-1">
          {article.excerpt}
        </p>
