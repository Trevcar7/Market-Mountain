...
const CHARTS: Record<BarChartVariant, ChartConfig> = {
  "sprouts-revenue": {
    ...
    data: [
      ...
      { label: "2026", values: [9.7] },
      { label: "2027", values: [10.8] },
      { label: "2028", values: [12.0] },
      { label: "2029", values: [13.3] },
    ],
    series: [{ name: "Revenue", color: "#2a783a", darkColor: "#4ADE80" }],
    yFormat: (v) => `$${v}B`,
    caption: "Revenue in billions USD. Forecast based on approximately 10 to 11% annual growth rate.",
  },
  "sprouts-profitability": {
