 ...
 */
export const FOMC_2026_MEETINGS = [
...
export async function fetchBriefingWhatToWatch(): Promise<Array<{
  ...
  // 0. Check for upcoming FOMC meeting (hardcoded calendar)
  // NOT added to events here — Claude will generate its own FOMC item from the prompt context.
  // This is only used as a FALLBACK if Claude doesn't mention FOMC and no FMP calendar data exists.
